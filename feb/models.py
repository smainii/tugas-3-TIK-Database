...
class Fakultas_feb(models.Model):
...
class Jurusan_feb(models.Model):
...
class Perkuliahan_feb(models.Model):
...
class Biodata_dosen_feb(models.Model):
...
class User_dosen_feb(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
...
class Biodata_tendik_feb(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    nama = models.CharField(max_length=100)
    tanggal_lahir = models.DateField()
    jenis_kelamin = models.CharField(max_length=20, null=True)
...
class User_tendik_feb(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    username = models.CharField(max_length=100)
    password = models.CharField(max_length=50)
...
class Biodata_mahasiswa_feb(models.Model):
...
class User_mahasiswa_feb(models.Model):
