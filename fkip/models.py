...
class Fakultas_fkip(models.Model):
...
class Jurusan_fkip(models.Model):
...
class MatKul_fkip(models.Model):
...
class Perkuliahan_fkip(models.Model):
...
class Biodata_dosen_fkip(models.Model):
...
class User_dosen_fkip(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
...
class Biodata_tendik_fkip(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    nama = models.CharField(max_length=100)
    tanggal_lahir = models.DateField()
    jenis_kelamin = models.CharField(max_length=20, null=True)
...
class User_tendik_fkip(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    username = models.CharField(max_length=100)
    password = models.CharField(max_length=50)
...
class Biodata_mahasiswa_fkip(models.Model):
...
class User_mahasiswa_fkip(models.Model):
