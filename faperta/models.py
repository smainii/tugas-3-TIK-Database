...
class MatKul(models.Model):
    nama = models.CharField(max_lhength=50)
    keterangan = models.TextField(null=True)
...
class Fakultas_faperta(models.Model):
...
class Jurusan_faperta(models.Model):
...
class MatKul_faperta(models.Model):
...
class Perkuliahan_faperta(models.Model):
...
class Biodata_dosen_faperta(models.Model):
...
class User_dosen_faperta(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
...
class Biodata_tendik_faperta(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    nama = models.CharField(max_length=100)
    tanggal_lahir = models.DateField()
    jenis_kelamin = models.CharField(max_length=20, null=True)
...
class User_tendik_faperta(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    username = models.CharField(max_length=100)
    password = models.CharField(max_length=50)
...
class Biodata_mahasiswa_faperta(models.Model):
...
class User_mahasiswa_faperta(models.Model):
