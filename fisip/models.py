...
class Fakultas_fisip(models.Model):
...
class Jurusan_fisip(models.Model):
...
class MatKul_fisip(models.Model):
...
class Perkuliahan_fisip(models.Model):
...
class Biodata_dosen_fisip(models.Model):
...
class User_dosen_fisip(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
...
class Biodata_tendik_fisip(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    nama = models.CharField(max_length=100)
    tanggal_lahir = models.DateField()
    jenis_kelamin = models.CharField(max_length=20, null=True)
...
class User_tendik_fisip(models.Model):
    nip_id = models.ForeignKey(Nip, on_delete=models.CASCADE, null=True)
    username = models.CharField(max_length=100)
    password = models.CharField(max_length=50)
...
class Biodata_mahasiswa_fisip(models.Model):
...
class User_mahasiswa_fisip(models.Model):
